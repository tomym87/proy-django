...
class Product(models.Model):
    ...
    e1 = models.CharField(max_length=100, unique=False, default='https://valtic.com.mx')
    e2 = models.CharField(max_length=100, unique=False, default='https://valtic.com.mx')
    e3 = models.CharField(max_length=100, unique=False, default='https://valtic.com.mx')
